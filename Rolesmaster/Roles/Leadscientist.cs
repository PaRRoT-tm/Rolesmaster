...
namespace Rolesmaster.Roles
{
    ...
    public class Leadscientist : CustomRole
    {
        public override uint Id { get; set; } = 12;
        public override int MaxHealth { get; set; } = 100;
        public override string Name { get; set; } = "Глава Учёных";
        public override string Description { get; set; } = "Главный учёный комплекса";
        public override string CustomInfo { get; set; } = "Leadscientist";
        ...
        public override void AddRole(Player player)
        {
            ...
            if (this.Role != RoleTypeId.None)
            {
                ...
                Timing.CallDelayed(1f, () =>
                {
                    ...
                    player.CustomName = $"{player.Nickname} | Глава Учёны";
